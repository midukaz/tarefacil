<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 py-8">
      <!-- Cabeçalho elegante -->
      <div class="mb-8">
        <h1 class="text-3xl font-light text-gray-900 mb-2">Rotinas</h1>
        <p class="text-gray-500 text-sm">Organize suas atividades diárias com consistência</p>
      </div>
      ...
      <div>
        ...
        <div v-if="rotinasStore.rotinasFiltradas.length === 0" class="text-center py-16">
          ...
          <h3 class="text-lg font-medium text-gray-900 mb-2">Nenhuma rotina encontrada</h3>
          <p class="text-sm text-gray-500">Crie uma nova rotina ou ajuste os filtros</p>
        </div>
      </div>
