<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
    <div class="max-w-4xl mx-auto px-4 py-8">
      <!-- Cabeçalho elegante -->
      <div class="mb-8">
        <h1 class="text-3xl font-light text-gray-900 dark:text-white mb-2">Eventos</h1>
        <p class="text-gray-500 dark:text-gray-400 text-sm">Gerencie seus compromissos e atividades especiais</p>
      </div>
      ...
      <div>
        ...
        <div v-if="eventosVisualizacao.length === 0" class="text-center py-16">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">Crie um novo evento ou ajuste os filtros</p>
        </div>
      </div>
