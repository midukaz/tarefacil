    ...
    <div class="space-y-3">
      ...
      >
        ...
        <div class="flex items-start justify-between mb-4">
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-3 mb-2">
              <h3 class="text-lg font-medium text-gray-900 dark:text-white truncate">{{ evento.titulo }}</h3>
              <div class="flex gap-1.5">
                <!-- Status concluído -->
                <span
                  v-if="evento.concluido"
                  class="px-2 py-1 text-xs font-medium bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-800 rounded-md"
                >
                  Concluído
                </span>
                <!-- Prioridade -->
                <span
                  :class="{
                    'bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-600': evento.prioridade === 'baixa',
                    'bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-400 border-orange-200 dark:border-orange-800': evento.prioridade === 'media',
                    'bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-red-200 dark:border-red-800': evento.prioridade === 'alta'
                  }"
            ...
            <p v-if="evento.descricao" class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-3">{{ evento.descricao }}</p>
          ...
          <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            ...
            <button
              ...
              class="p-2 text-gray-400 dark:text-gray-500 hover:text-amber-500 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-lg transition-colors"
        ...
        <div v-if="evento.lembretes.length > 0" class="mb-4">
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Lembretes</h4>
